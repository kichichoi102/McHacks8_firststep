(function () {
  ...
  const submitButton = document.querySelector("wired-button");
  ...
  // Local Storage of journal entries
  var entries = [];
  readData();
  updateEntries();
  ...
  function updateEntries() {
    ...
    entries.forEach(function (entry, index) {
      const displayEntryBtn = document.createElement("wired-button");
      ...
      const deleteEntryBtn = document.createElement("wired-button");
  ...
  function saveData() {
      localStorage.setItem("gratefulnessEntries", JSON.stringify(entries));
  ...
  submitButton.addEventListener("click", onEntrySubmit);
})();
